  ...
  return (
    <div className="   h-screen px-4  md-container ">
      <div className="grid  md:grid-cols-2 mx-auto flex-col max-w-[2600px] ">
        <div
          className="md:py-[26%] lg:py-[24%]   2xl:py-52 3xl:py-52 3mxl:py-60 w-full 4xl:items-start 4xl:py-64 justify-center
        ...
        <div className="  items-start    ">
          ...
          <img
            src={Group13}
            className=" absolute xs:w-[95%] sm:w-[97%] sm:ml-0 md:w-[44%] md:ml-[6%] lg:ml-[10%] lg:w-[40%] xl:w-[42%]   xl:ml-[8%] 2xl:w-[40%] 2xl:ml-[10%] 3xl:ml-[10%]  3xl:w-[40%] 4xl:w-[37%] 4xl:ml-[13%]  "
            alt=""
          />
          <img
            className=" absolute xs:w-[94%] xs:mt-[35%] sm:w-[94%] sm:ml-0 md:mt-[22%]  xl:w-[33%]  xl:mt-[22%] xl:ml-[9%] md:ml-[8%] md:w-[35%] lg:ml-[11%] lg:mt-[20%] 2xl:ml-[10%] 2xl:mt-[20%] 3xl:w-[39%] 3xl:mt-[19%] 3xl:ml-[9%] 4xl:w-[39%] 4xl:ml-[11%] 4xl:mt-[18%]   "
            src={Card2}
            alt=""
          />
          <img
            className=" absolute xs:w-[94%] xs:mt-[10%] sm:w-[94%] sm:ml-0 xl:w-[36%] xl:mt-[9%] xl:ml-[-2%] md:mt-[10%] md:ml-[-3%] md:w-[35%] cursor-pointer lg:mt-[8%] 2xl:ml-[0%] 3xl:mt-[7%] 3xl:ml-[0%] 3xl:w-[39%] lg:ml-[1%] 4xl:w-[39%] 4xl:ml-[2%] 4xl:mt-[6%]  "
            src={Card1}
            alt=""
          />
        </div>
