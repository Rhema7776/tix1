  ...
  return (
    <div className=" py-[25%]  h-screen px-4  md-container ">
      <div className="grid w-full md:grid-cols-2 bg-red-500   flex-col justify-between max-w-[1600px] ">
        <div
          className="  md:py-10 flex flex-col justify-center
        ...
        >
          ...
          <div className="flex  justify-between xs:w-[100%]  sm:w-[60%] w-[80%] md:py-1 py-6 md:w-[100%] lg:w-[86%] xl:w-[85%] bg-blue-500">
            <div className="flex xs:flex-col sm:flex-row  bg-red-300 w-[42%]  items-center">
            ...
            <div className="flex xs:flex-col sm:flex-row  bg-blue-300 w-[50%] items-center">
        ...
        <div className="w-full bg-violet-500  ">    
         fldvsdcsxz
          {/* bg-violet-500 */}
          <img className="absolute md:w-[270px] md:mt-[200px] xl:mt-[200px] xl:w-[25%] lg:w-[35%] lg:h-[350px] lg:mt-[200px] xl:h-[400px] md:h-[280px] w-[70%] md:ml-[10%] ml-[6%]  md:w-[40%] mt-[12%] "  src={Card2} alt="" />
